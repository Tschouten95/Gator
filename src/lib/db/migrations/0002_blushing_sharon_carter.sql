...
ALTER TABLE "feedFollows" DROP CONSTRAINT "feed_follows_user_id_feed_id_unique";--> statement-breakpoint
ALTER TABLE "feedFollows" DROP CONSTRAINT "feed_follows_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "feedFollows" DROP CONSTRAINT "feed_follows_feed_id_feeds_id_fk";
--> statement-breakpoint
